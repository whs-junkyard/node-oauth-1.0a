...
describe("last_ampersand option", function() {
    ...
    describe("default (true)", function() {
        ...
        it("should be equal to Twitter example", function() {
            expect(oauth._getSigningKey(token.secret)).to.equal('kAcSOqF21Fu85e7zjz7ZN2U4ZRhfV3WpwPAoE3Z7kBw&LswwdoUaIvS8ltyTt5jkRh4J50vUPVVHtR2YPi5kE');
        });

        it("should has the ampersand at the end", function() {
            expect(oauth._getSigningKey()).to.equal('kAcSOqF21Fu85e7zjz7ZN2U4ZRhfV3WpwPAoE3Z7kBw&');
        });
    });
